...
<head>
	...
	<title>SIREGM | @yield('titulo')</title>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			<img class="animation__wobble" src="{{ asset('logo.jpg') }}" alt="LOGO" height="260" width="260">
		</div>
					...
					<!-- Add icons to the links using the .nav-icon class
						...
						<li class="nav-item lk-jefes_home lk-provincia_home lk-municipio_home lk-cs_home lk-especialidad_home lk-pais_home">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="{{ route('reportes_home') }}" class="nav-link lk-especialidad_home">
										<i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('reportes_home') }}" class="nav-link lk-reportes_home">
