...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			<img class="animation__wobble" src="<?php echo e(asset('logo.png')); ?>" alt="AdminLTELogo" height="260" width="260">
		</div>
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4">
		...
		<a href="index3.html" class="brand-link">
			<img src="<?php echo e(asset('logo.png')); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
					...
					<!-- Add icons to the links using the .nav-icon class
						...
						<li class="nav-item lk-jefes_home lk-provincia_home lk-municipio_home lk-cs_home lk-especialidad_home lk-pais_home">
							...
							<ul class="nav nav-treeview">
                                <li class="nav-item">
									<a href="<?php echo e(route('jefes_home')); ?>" class="nav-link lk-jefes_home">
								...
								<li class="nav-item">
									<a href="<?php echo e(route('cs_home')); ?>" class="nav-link lk-cs_home">
										<i class="far fa-circle nav-icon"></i>
										<p>Centros de Salud</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?php echo e(route('especialidad_home')); ?>" class="nav-link lk-especialidad_home">
										<i class="far fa-circle nav-icon"></i>
										<p>Especialidades</p>
									</a>
								</li>
                                <li class="nav-item">
									<a href="<?php echo e(route('pais_home')); ?>" class="nav-link lk-pais_home">
										<i class="far fa-circle nav-icon"></i>
										<p>Paises</p>
									</a>
								</li>
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('colaboradores_home')); ?>" class="nav-link lk-colaboradores_home lk-misiones_home">
    ...
    <!-- ChartJS -->
	<script src="<?php echo e(asset('plantilla/plugins/chart.js/Chart.min.js')); ?>"></script>
    <!-- SweetAlert2 -->
