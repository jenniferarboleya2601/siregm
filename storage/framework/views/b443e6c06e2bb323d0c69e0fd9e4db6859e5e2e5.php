            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <?php echo Form::label('jefe_id', 'Entidad', ['class'=>'form-label']); ?>
                        ...
                        <?php echo Form::label('rol', 'Nivel de Acceso', ['class'=>'form-label']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sigecol/resources/views/admin/usuarios/home.blade.php ENDPATH**/ ?>