<?php $__env->startSection('titulo', 'Jefes'); ?>

<?php $__env->startSection('nav-superior'); ?>
<li class="breadcrumb-item"><a href="<?php echo e(route('jefes_home')); ?>">Jefes</a></li>
      ...
      <div class="modal-content">
        <?php echo Form::open(['id'=>"frmNuevo", 'method'=>"POST", 'onsubmit'=>"return nuevo()"]); ?>
            ...
            <div class="modal-body">
                <?php echo Form::label('jefe', 'Nombre', ['class'=>'form-label']); ?>

                <?php echo Form::text('jefe', null, ['id'=>'jefe','class'=>'form-control','autocomplete'=>'off','required'=>'true']); ?>
...
<script src="<?php echo e(asset('js/paginas/jefes.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sigecol/resources/views/nomencladores/jefes/home.blade.php ENDPATH**/ ?>